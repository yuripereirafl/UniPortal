...
# Garantindo que as colunas existam no banco de dados
try:
...
try:
    cursor.execute("ALTER TABLE funcionarios ADD COLUMN data_inativado TEXT;")
except sqlite3.OperationalError:
    print("Coluna 'data_inativado' já existe.")
